                ...
                <GlassPanel title="Deploy New Application">
                    <div className="p-4 flex flex-col gap-4">
                        ...
                        <div className="flex justify-end gap-2 mt-2">
                             <button onClick={onClose} className="px-4 py-2 bg-slate-500/30 hover:bg-slate-500/50 border border-slate-500/50 text-slate-200 font-bold rounded transition-colors">
                                Cancel
                            </button>
                            <button onClick={handleSubmit} disabled={!name.trim() || !description.trim()} className="px-4 py-2 bg-green-500/30 hover:bg-green-500/50 border border-green-500/50 text-green-200 font-bold rounded transition-colors disabled:opacity-50">
                                Confirm & Deploy
                            </button>
                        </div>
                    </div>
