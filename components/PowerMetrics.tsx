        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{totalPowerDraw.toFixed(1)} W</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{pue.toFixed(3)}</p>
            </div>
          </div>
          <div className="text-sm text-gray-400">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{Math.max(0, cryoTemp).toFixed(3)} K</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between border-t border-cyan-700/50 pt-4 mt-2">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-purple-300">{qnnPrediction.toFixed(3)}</p>
            </div>
          </div>
