  ...
  return (
    <div className="flex items-center space-x-3 relative">
      ...
      <div className="text-right hidden sm:block">
        <p className="text-sm text-white font-semibold">Resource Steward</p>
        <p className={`text-xs ${currentConfig.statusText} transition-colors`}>{currentConfig.statusLabel}</p>
      </div>
      <button 
        onClick={handleClick}
